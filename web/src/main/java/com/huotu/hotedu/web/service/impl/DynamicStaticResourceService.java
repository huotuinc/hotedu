 ...
 * 动态静态资源处理器
 * <p>请务必设置环境变量</p>
 * <code>fanmore.resourcesUri</code>
 * <p>比如<code>http://res.fanmore.cn/</code></p>
 * <code>fanmore.resourcesHome</code>
...
public class DynamicStaticResourceService extends AbstractStaticResourceService{
    ...
    private void setEnv(Environment env) {
        String uri = env.getProperty("fanmore.resourcesUri", (String) null);
        if (uri==null){
            throw new IllegalStateException("请设置fanmore.resourcesUri和fanmore.resourcesHome属性");
        }
        String home = env.getProperty("fanmore.resourcesHome", (String) null);
        if (home==null){
            throw new IllegalStateException("请设置fanmore.resourcesUri和fanmore.resourcesHome属性");
        }
