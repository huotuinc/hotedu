...
public class MessageContentController {
    ...
    public String loadMessageContents(Model model){
        ...
        return "/backend/messagecontents";
    }

    //后台单机搜索按钮显示的考试指南消息
    @RequestMapping("/backend/search/messagecontents")
    public String searchMessageContents(String keywords,Model model){
    ...
    //后台单击考试指南的分页
    @RequestMapping("/backend/page/messagecontents")
    public String pageMessageContents(int n,int sumpage,String keywords,Model model){
    ...
    //后台单击删除按钮返回的信息
    @RequestMapping("/backend/del/messagecontents")
    public String DelMessageContents(int n,int sumpage,String keywords,Long id,Long sumElement,Model model){
    ...
    //后台单击新建按钮
    @RequestMapping("/backend/add/messagecontents")
    public String AddMessageContents(Model model){
        return "/backend/newmessagecontent";
    }
    //后台单机修改按钮
    @RequestMapping("/backend/modify/messagecontents")
    public String ModifyMessageContents(Long id, Model model){
    ...
    //后台单击添加保存按钮
    @RequestMapping("/backend/addsave/messagecontents")
    public String AddSaveMessageContents(String title,String content,String top,Model model){
        ...
        return "redirect:/backend/load/messagecontents";
    }


    //后台单击修改保存按钮
    @RequestMapping("/backend/modifysave/messagecontents")
    public String ModifySaveMessageContents(Long id,String title,String content,Boolean top,Model model){
        MessageContent messageContent=messageContentService.findOneById(id);
        messageContent.setTitle(title);
        messageContent.setContent(content);
